                            ...
                            <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                    ...
                                    <?=form_open('detalle')?>
                                        ...
                                        <input type="text" name="cod_area" placeholder="(Cod Área)..."/>
                                        <input type="text" name="numero" placeholder="Número Teléfono"/>
                                        <input type="text" name="calle" placeholder="Calle"/>
                                        <input type="text" name="numero_casa" placeholder="Número"/>
